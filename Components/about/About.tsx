...
const About = () => {
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      {/* About Section */}
      <section className="flex flex-col sm:justify-center max-w-5xl mx-auto mt-16 px-6 text-gray-800">
        <h3
          className="text-xl sm:text-2xl md:text-2xl font-medium mb-2
      ...
      md:ml-[20px]"
        ...
        <h1
          ...
          text-left md:text-left md:ml-[20px]
          leading-snug
        "
        >
          Built for minds that build
        </h1>

        <div className="flex flex-col gap-12 max-w-5xl mx-auto px-4 mb-6">
          {/* Block 1 */}
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            />
            <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-700 text-center text-left">
